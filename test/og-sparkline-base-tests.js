...
function runBaseTests() {
  og_sparkline_1 = document.getElementById('og_sparkline_1');

  suite('Base Automation Tests for og-sparkline', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-sparkline fixture is created', function() {
      assert.isTrue(document.getElementById('og_sparkline_1') !== null);
    });
